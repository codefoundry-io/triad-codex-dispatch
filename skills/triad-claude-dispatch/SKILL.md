...
--effort xhigh --pydantic verdict_schema:LegVerdict`. Claude reviews only; it
does not edit or execute candidate code. One validated result belongs to one
review ID and content digest.
