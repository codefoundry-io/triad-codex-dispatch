...
public repository clone을 안정적인 checkout으로 사용합니다. 설치 후에도 지우지 마세요.
생성된 launcher가 이 checkout의 wrapper 파일을 실행합니다.
...
- 생성된 command rules는 이 checkout의 wrapper launcher만 허용합니다.
