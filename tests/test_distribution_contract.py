...
def test_current_release_docs_bind_the_superseded_agy_route_and_pending_r6_candidate() -> None:
    ...
    assert "post-r5 bounded-correction" in handoff
    assert "final-0.2.533-r6" in handoff
